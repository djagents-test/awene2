...
import FormationRegistrationForm from "./formation-registration-form";
...
export async function generateFrenchFormationMetadata(
  slug: string,
): Promise<Metadata> {
...
export async function renderFrenchFormationPage(slug: string) {
  const formation = await getFormationBySlug(slug);
