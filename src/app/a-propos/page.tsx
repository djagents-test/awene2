...
const certifications = [
  ...
  "En formation : Longevity for Women in Menopause and Perimenopause",
  "En formation : Théorie polyvagale appliquée, Polyvagal Institute",
];

const headingClass = "text-4xl font-bold md:text-5xl";
const copyClass = "text-base leading-relaxed md:text-lg";
const convictionHighlights = [
  {
    title: "transitions réelles",
    description:
      "La périménopause et la ménopause sont des réalités biologiques documentées, pas un flou à subir.",
    icon: "leaf",
  },
  {
    title: "compréhension du corps",
    description:
      "Comprendre hormones, symptômes et système nerveux permet de retrouver du sens et de la marge d'action.",
    icon: "thermo",
  },
  {
    title: "accompagnement scientifique",
    description:
      "Un cadre sérieux, ancré dans la science, pensé pour la vie réelle de chaque femme.",
    icon: "brain",
  },
] as const;
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <PageHero
        ...
        visualTone="mixed"
        contentClassName="max-w-none lg:max-w-[46rem]"
      />
          ...
          <div className="grid gap-10 lg:gap-12">
            <div className="grid items-stretch lg:grid-cols-[minmax(0,1.05fr)_minmax(20rem,0.95fr)]">
              <div className="order-2 py-4 lg:order-1 lg:pr-14 lg:py-6">
                ...
                <h2 className="mb-4 text-4xl leading-[1.02] font-bold md:text-5xl" style={{ fontFamily: "var(--font-playfair)", color: "#2B2240" }}>
                  Ce que nous croyons
                </h2>
                <div className="mb-8 h-px w-16 rounded-full" style={{ background: "#F68B2C" }} />
                <div className="grid gap-6">
                  {convictionHighlights.map((item, index) => (
                    <div key={item.title} className="flex items-start gap-4">
                      ...
                      >
                        <ConvictionIcon kind={item.icon} />
                      </div>
                      <p className="text-base leading-relaxed md:text-[1.02rem]" style={{ color: "#5A5670", fontFamily: "var(--font-inter)" }}>
                        {index === 0 && "La périménopause et la ménopause ne sont pas une maladie. Ce ne sont pas non plus des années à subir en silence, avec des bouffées de chaleur, une fatigue chronique, un brouillard mental, des troubles du sommeil ou une prise de poids inexpliquée."}
                        {index === 1 && "Ce sont des transitions biologiques réelles, documentées, compréhensibles, et traversables avec les bons outils."}
                        {index === 2 && "AWENE est né d'une conviction simple : chaque femme mérite de comprendre ce qui se passe dans son corps, ses hormones, son système nerveux, ses symptômes, et d'avoir accès à un accompagnement sérieux, ancré dans la science, adapté à sa réalité."}
                      </p>
                    </div>
                  ))}
                </div>
            ...
            <div className="overflow-hidden rounded-[1.25rem] bg-[linear-gradient(90deg,#d9cbff_0%,#f6ddd1_100%)] px-6 py-6 md:px-8 md:py-7 lg:px-10">
              <div className="grid gap-5 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:items-center">
                ...
                <p
                  className="text-lg leading-relaxed italic md:text-[1.6rem]"
      ...
      <Section background="lavender" size="md">
        <Container>
          <div className="relative py-4 md:py-6">
            ...
            <svg
              viewBox="0 0 220 220"
              className="absolute -right-6 top-12 h-44 w-44 md:h-56 md:w-56"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
            >
              <path
                d="M215 20C168 30 145 68 146 112C146 156 127 191 92 215"
                stroke="rgba(246,139,44,0.22)"
                strokeWidth="1.4"
                strokeLinecap="round"
              />
            </svg>
            ...
            <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.78fr)] lg:gap-14">
              <div>
                <h2
                  className="text-4xl leading-[0.95] font-bold uppercase md:text-5xl lg:text-6xl"
                  style={{ fontFamily: "var(--font-playfair)", color: "#241c38" }}
                >
                  <span style={{ color: "#6F3FD6", fontStyle: "italic", fontWeight: 500, textTransform: "none" }}>Pas</span> UNE
                  <br />
                  AUTRE
                  <br />
                  PLATEFORME
                  <br />
                  DE{" "}
                  <span style={{ color: "#6F3FD6", fontStyle: "italic", fontWeight: 500, textTransform: "none" }}>
                    Bien-être.
                  </span>
                </h2>
              </div>
              ...
              <div className="max-w-[30rem] lg:pt-3">
                ...
                >
                  <p>AWENE n&apos;est pas du coaching intuitif.</p>
                  <p>Ce n&apos;est pas de la pensée positive.</p>
                  <p>Ce n&apos;est pas des solutions miracles.</p>
                </div>
                <div
                  className="my-6 h-px w-10 rounded-full"
                  style={{ background: "rgba(246,139,44,0.6)" }}
                />
                <p
        ...
        <Container>
          <div className="grid grid-cols-1 gap-10 lg:gap-12">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(16rem,21rem)_minmax(0,1fr)] lg:items-stretch lg:gap-12">
              <div className="w-full max-w-[22rem] mx-auto lg:mx-0 lg:max-w-none">
              ...
              <div className="flex h-full flex-col">
                ...
                <h2 className={`${headingClass} mb-4`} style={{ fontFamily: "var(--font-playfair)", color: "#2E2438" }}>Amira Medimagh</h2>
                <p className="mb-7 text-base font-semibold leading-relaxed md:text-lg" style={{ color: "#F68B2C", fontFamily: "var(--font-inter)" }}>
                  Médecin. Experte en santé publique.
                  <br />
                  Coach certifiée.
                </p>
                <div className="space-y-5" style={{ color: "#6E6478", fontFamily: "var(--font-inter)" }}>
                  <p className={copyClass}>Amira Medimagh est médecin, titulaire d&apos;un Master en santé publique avec plus de 20 ans d&apos;expérience en santé publique internationale, notamment en santé sexuelle et reproductive, VIH-SIDA, et droits des femmes, en Tunisie et dans la région MENA.</p>
                  <p className={copyClass}>Depuis 2025, elle est certifiée coach en santé et nutrition intégrative par l&apos;Institute for Integrative Nutrition (États-Unis), et coach certifiée en périménopause et ménopause par l&apos;Integrative Women&apos;s Health Institute.</p>
                  <p className={copyClass}>Elle se forme actuellement à la théorie polyvagale et à la longévité féminine, pour intégrer les approches les plus récentes en neuroscience, santé hormonale et santé féminine dans son accompagnement.</p>
                </div>
              </div>
            </div>

            <div className="group rounded-[2rem] p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(75,31,122,0.12)] md:p-8 lg:col-span-2" style={{ background: "#F3ECFB" }}>
              <div className="grid gap-8 lg:grid-cols-[minmax(14rem,18rem)_minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-10">
                <div className="transition-transform duration-300 group-hover:-translate-y-0.5">
                  <div className="relative aspect-[3.2/2.6] w-full overflow-hidden rounded-[1.5rem] shadow-[0_10px_24px_rgba(75,31,122,0.06)] transition-all duration-300 group-hover:shadow-[0_18px_34px_rgba(75,31,122,0.14)]">
                    <Image
                      ...
                      alt="Femme accompagnant une autre femme dans un moment de soutien emotionnel"
                      fill
                ...
                <div className="transition-transform duration-300 group-hover:-translate-y-0.5">
                  <h3 className="mb-4 text-2xl font-bold transition-colors duration-300 group-hover:text-[#6F3FD6]" style={{ fontFamily: "var(--font-playfair)", color: "#4B1F7A" }}>Pourquoi ce chemin</h3>
                  <p className="text-sm leading-relaxed md:text-[0.97rem]" style={{ color: "#6E6478", fontFamily: "var(--font-inter)" }}>
                ...
                <div className="transition-transform duration-300 group-hover:-translate-y-0.5">
                  <h3 className="mb-4 text-2xl font-bold transition-colors duration-300 group-hover:text-[#6F3FD6]" style={{ fontFamily: "var(--font-playfair)", color: "#4B1F7A" }}>Ce qui la distingue</h3>
                  <p className="text-sm leading-relaxed md:text-[0.97rem]" style={{ color: "#6E6478", fontFamily: "var(--font-inter)" }}>
        ...
        <Container>
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
            <div className="lg:col-span-10 lg:col-start-2">
              <h2 className={`${headingClass} mb-8`} style={{ fontFamily: "var(--font-playfair)", color: "#2E2438" }}>Formations et certifications</h2>
              <div className="mb-8 hidden md:block">
                <PlaceholderVisual variant="card" tone="apricot" className="aspect-[4.8/1.25] w-full rounded-[1.75rem]" />
              </div>
              <ul className="space-y-3">
                {certifications.map((item) => (
                  <li key={item} className="rounded-2xl border bg-white p-4 text-base leading-relaxed transition-all duration-300 hover:-translate-y-0.5 hover:border-[#D8C7F3] hover:shadow-[0_14px_30px_rgba(75,31,122,0.08)] md:text-lg" style={{ borderColor: "#E8DFF0", color: "#2E2438", fontFamily: "var(--font-inter)" }}>
                    {item}
                  </li>
                ))}
              </ul>
