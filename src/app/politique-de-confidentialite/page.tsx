          ...
          <div className="space-y-10">
            {[
              ...
              },
              {
                ...
                body: "AWENE, Accompagnement en neuro wellness et transition ménopausique. Pour toute réclamation relative au traitement de vos données, vous pouvez saisir la CNIL (Commission Nationale de l'Informatique et des Libertés).",
              },
            ].map((section) => (
