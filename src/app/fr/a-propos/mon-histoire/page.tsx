    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ background: "#FCFAF8" }}>
        <Container className="relative z-10 pt-32 pb-20">
          <div className="max-w-3xl">
            ...
            >
              Ce que je vis, ce que j&apos;ai traversé, et pourquoi tout cela m&apos;a conduit à créer AWENE.
            </p>
          </div>
        </Container>
      </section>
      ...
      <Section background="white" size="lg">
        <Container size="md">
          ...
          >
            <Button href="/fr/a-propos/pourquoi-awene" variant="primary">
              Pourquoi AWENE
            </Button>
            <Button href="/fr/chemine-avec-moi" variant="secondary">
              Cheminer avec moi
            </Button>
          </div>
        </Container>
