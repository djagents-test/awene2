...
export default function PourquoiAWENE() {
  return (
    <>
      <JsonLd
        data={webPageSchema({
          path: "/fr/a-propos/pourquoi-awene",
          title: "Pourquoi AWENE",
          description:
            "Le nom, le mouvement, la mission, comprendre la raison d'être profonde d'AWENE.",
          type: "AboutPage",
      ...
      <section className="relative overflow-hidden" style={{ background: "#FCFAF8" }}>
        <Container className="relative z-10 pt-32 pb-20">
          <div className="max-w-3xl">
            ...
            >
              Un nom. Un mouvement. Une conviction que la ménopause mérite mieux que le silence ou les demi-réponses.
            </p>
          </div>
        </Container>
      </section>
      ...
      <Section background="lavender" size="md">
        <Container size="md" className="text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Button href="/fr/chemine-avec-moi" variant="primary">
              Cheminer avec moi
            </Button>
            <Button href="/fr/a-propos/mon-histoire" variant="secondary">
              Mon histoire
            </Button>
          </div>
        </Container>
