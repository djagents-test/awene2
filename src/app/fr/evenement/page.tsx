      ...
      <Container>
        ...
        {past ? (
          <div className="mt-16 space-y-12">
            ...
            {pv?.gallery?.length ? (
              <section className="rounded-[2rem] border bg-white p-8" style={{ borderColor: "#E8DFF0" }}>
                <h2 className="mb-4 text-3xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#2E2438" }}>Galerie</h2>
          ...
          <section className="mt-16 rounded-[2rem] border bg-white p-8" style={{ borderColor: "#E8DFF0" }}>
            <h2 className="mb-4 text-3xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#2E2438" }}>Inscription</h2>
