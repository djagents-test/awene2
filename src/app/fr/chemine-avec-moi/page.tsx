...
const paths = [
  {
    ...
    href: "/fr/chemine-avec-moi/role-du-coach",
    bg: "#F3ECFB",
    color: "#6F3FD6",
  },
];
      ...
      <section className="relative overflow-hidden" style={{ background: "#FCFAF8" }}>
        <Container className="relative z-10 pt-32 pb-20">
          <div className="max-w-3xl">
            ...
            >
              L&apos;accompagnement AWENE est structuré, intentionnel et profondément humain. Voici comment il fonctionne, et comment commencer.
            </p>
          </div>
        </Container>
      </section>
