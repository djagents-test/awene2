  ...
  return (
    <>
      ...
      >
        ...
        >
          Ce formulaire n&apos;est pas un test. C&apos;est une invitation à vous poser,
          à réfléchir à votre situation et à partager ce qui vous amène ici.
          Il nous aide à comprendre si l&apos;accompagnement AWENE est adapté à votre moment.
        </p>
        <p
          className="text-sm italic"
          style={{ color: "#6E6478", fontFamily: "var(--font-playfair)" }}
        >
          Toutes vos réponses sont confidentielles. Elles ne servent qu&apos;à préparer
